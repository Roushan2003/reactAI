...
import QuestionAnswer from "./components/QuestionAnsawer";
    ...
    <div className={darkMode=='dark'?'dark':'light'}>
      <div className="grid grid-cols-5 h-screen text-center">
        ...
        <div className="col-span-4 p-10 overflow-visible">
          ...
          <div className="dark:bg-zinc-800 p-1 bg-red-100 pr-5 w-1/2 dark:text-white text-zinc-800 m-auto rounded-4xl border border-zinc-400 flex h-16">
            <input
              type="text"
              value={question}
              onKeyDown={isEnter}
